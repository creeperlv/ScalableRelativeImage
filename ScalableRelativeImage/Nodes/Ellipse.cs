...
namespace ScalableRelativeImage.Nodes
{
    public class Ellipse : GraphicNode
    {
        ...
        public override void Paint(ref Graphics TargetGraphics, RenderProfile profile)
        {
            ...
            if(Fill is not true)
            TargetGraphics.DrawEllipse(new((Foreground == null ? profile.DefaultForeground : Foreground.Value), RealWidth), new System.Drawing.Rectangle(new System.Drawing.Point((int)LT.X, (int)LT.Y),new Size(
                (int)(Width / profile.root._RelativeWidth * profile.TargetWidth), (int)(Height / profile.root._RelativeHeight* profile.TargetHeight))));
            else
                TargetGraphics.FillEllipse(new SolidBrush((Foreground == null ? profile.DefaultForeground : Foreground.Value)), new System.Drawing.Rectangle(new System.Drawing.Point((int)LT.X, (int)LT.Y), new Size(
    (int)(Width / profile.root._RelativeWidth * profile.TargetWidth), (int)(Height / profile.root._RelativeHeight * profile.TargetHeight))));
